...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, o as binding_callbacks, p as bind, v as validate_slots, a7 as afterUpdate, u as get, w as ihttp, b as space, e as element, A as create_component, f as attr_dev, c as add_location, g as set_style, h as insert_dev, B as mount_component, j as append_dev, C as add_flush_callback, E as transition_in, G as transition_out, l as detach_dev, H as destroy_component, U as URI_SETTING, T as globals } from './main-1d28085c.js';
...
/* src\pages\RedaksiDeduktif.svelte generated by Svelte v3.46.4 */

const { document: document_1 } = globals;
const file = "src\\pages\\RedaksiDeduktif.svelte";
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h1, file, 39, 4, 934);
			add_location(br0, file, 42, 8, 998);
			add_location(strong0, file, 43, 12, 1016);
			attr_dev(h30, "class", "svelte-1hc36yd");
			add_location(h30, file, 43, 8, 1012);
			attr_dev(p0, "class", "svelte-1hc36yd");
			add_location(p0, file, 44, 8, 1064);
			add_location(br1, file, 45, 8, 1094);
			add_location(strong1, file, 46, 12, 1112);
			attr_dev(h31, "class", "svelte-1hc36yd");
			add_location(h31, file, 46, 8, 1108);
			attr_dev(p1, "class", "svelte-1hc36yd");
			add_location(p1, file, 47, 8, 1157);
			attr_dev(p2, "class", "svelte-1hc36yd");
			add_location(p2, file, 48, 8, 1192);
			add_location(br2, file, 49, 8, 1224);
			add_location(strong2, file, 50, 12, 1242);
			attr_dev(h32, "class", "svelte-1hc36yd");
			add_location(h32, file, 50, 8, 1238);
			attr_dev(p3, "class", "svelte-1hc36yd");
			add_location(p3, file, 51, 8, 1282);
			add_location(br3, file, 52, 8, 1314);
			add_location(strong3, file, 53, 12, 1332);
			attr_dev(h33, "class", "svelte-1hc36yd");
			add_location(h33, file, 53, 8, 1328);
			attr_dev(p4, "class", "svelte-1hc36yd");
			add_location(p4, file, 54, 8, 1371);
			attr_dev(p5, "class", "svelte-1hc36yd");
			add_location(p5, file, 55, 8, 1399);
			attr_dev(div0, "class", "content svelte-1hc36yd");
			add_location(div0, file, 41, 4, 967);
			...
			add_location(main, file, 31, 0, 804);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	validate_slots('RedaksiDeduktif', slots, []);
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<RedaksiDeduktif> was created with unknown prop '${key}'`);
	});
...
class RedaksiDeduktif extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
export { RedaksiDeduktif as default };
//# sourceMappingURL=RedaksiDeduktif-d3de53cd.js.map
