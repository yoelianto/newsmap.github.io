...
/* src\pages\RewaraDetail.svelte generated by Svelte v3.46.4 */

const file = "src\\pages\\RewaraDetail.svelte";
	...
	articledetail = new ArticleDetail({
			props: {
				data: {
					...
					})["env"]["URL_IMAGE"] + "rewara/" + /*data*/ ctx[11].thumbnail,
...
// (33:20)      <div class="placeholder-container">         <Fa icon={faSpinner}
function create_pending_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "placeholder-container");
			add_location(div, file, 33, 4, 908);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "pending",
		source: "(33:20)      <div class=\\\"placeholder-container\\\">         <Fa icon={faSpinner}",
		ctx
	});
...
function instance($$self, $$props, $$invalidate) {
	...
	validate_slots('RewaraDetail', slots, []);
	let height;
	let url, title;
	let page = 'artikel';
	let { params = {} } = $$props;
	...
	const fetchData = async () => {
		const result = await get(`${URI_REWARA_DETAIL}/${slug}`);
		return await result;
	};
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<RewaraDetail> was created with unknown prop '${key}'`);
	});
...
class RewaraDetail extends SvelteComponentDev {
	constructor(options) {
		super(options);
	...
	get params() {
		throw new Error("<RewaraDetail>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set params(value) {
		throw new Error("<RewaraDetail>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
}

export { RewaraDetail as default };
//# sourceMappingURL=RewaraDetail-2659eabc.js.map
