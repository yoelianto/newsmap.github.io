...
/* src\pages\deduktif\about.svelte generated by Svelte v3.46.4 */

const { document: document_1 } = globals;

const file = "src\\pages\\deduktif\\about.svelte";
...
function create_catch_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(p, file, 50, 12, 1376);
		},
...
function create_pending_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 44, 12, 1169);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(main, file, 32, 0, 941);
		},
...
//# sourceMappingURL=about-8a755dcc.js.map
