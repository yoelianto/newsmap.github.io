...
/* src\pages\rewara\[slug].svelte generated by Svelte v3.46.4 */
const file = "src\\pages\\rewara\\[slug].svelte";
...
// (32:20)      <div class="placeholder-container">         <Fa icon={faSpinner}
function create_pending_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file, 32, 4, 936);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "pending",
		source: "(32:20)      <div class=\\\"placeholder-container\\\">         <Fa icon={faSpinner}",
		ctx
	});
...
//# sourceMappingURL=_slug_-4920b2b8.js.map
