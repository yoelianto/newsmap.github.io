...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, q as handle_promise, v as validate_slots, a4 as onMount, u as get, w as ihttp, F as Fa, x as faSpinner, y as faAngleLeft, z as faAngleRight, I as empty, h as insert_dev, D as update_await_block_branch, E as transition_in, G as transition_out, l as detach_dev, al as URI_DEDUKTIF_DETAIL, o as binding_callbacks, p as bind, am as URI_DEDUKTIF_LIST, e as element, c as add_location, n as noop, A as create_component, b as space, B as mount_component, C as add_flush_callback, H as destroy_component, f as attr_dev } from './main-477e1cc7.js';
import ArticleDetail from './ArticleDetail-18037715.js';
import { H as Head } from './Head-bc165711.js';
import { a as animateScroll, s as scrollToTop } from './index-bc0e1ad4.js';
import { S as Share } from './Share-368634c7.js';
import './moment-ffd3e3a3.js';
import './Router-29db7ec6.js';

/* src\pages\DeduktifDetail.svelte generated by Svelte v3.46.4 */

const file = "src\\pages\\DeduktifDetail.svelte";
...
function create_then_block(ctx) {
	...
	if (/*url*/ ctx[1] !== void 0) {
		share_props.url = /*url*/ ctx[1];
	}

	if (/*title*/ ctx[2] !== void 0) {
		share_props.title = /*title*/ ctx[2];
	}
	...
	articledetail = new ArticleDetail({
			props: {
				data: {
					...
					})["env"]["URL_IMAGE"] + type + "/" + /*data*/ ctx[11].thumbnail,
					thumbnail_social: /*data*/ ctx[11].thumbnail_social === undefined
					? ''
					: ({
							"env": {
								"DOMAIN": "https://admin-dev.jurno.id/",
						...
						})["env"]["URL_IMAGE"] + type + "/" + /*data*/ ctx[11].thumbnail_social,
					footer: {
						uri: URI_DEDUKTIF_LIST,
						params: { except: /*data*/ ctx[11].id, size: 3 },
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (!updating_url && dirty & /*url*/ 2) {
				updating_url = true;
				share_changes.url = /*url*/ ctx[1];
				add_flush_callback(() => updating_url = false);
			}

			if (!updating_title && dirty & /*title*/ 4) {
				updating_title = true;
				share_changes.title = /*title*/ ctx[2];
...
// (37:20)    <div class="placeholder-container">     <Fa icon={faSpinner}
function create_pending_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "placeholder-container svelte-f0b7j");
			add_location(div, file, 37, 2, 894);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "pending",
		source: "(37:20)    <div class=\\\"placeholder-container\\\">     <Fa icon={faSpinner}",
		ctx
	});
...
function instance($$self, $$props, $$invalidate) {
	...
	validate_slots('DeduktifDetail', slots, []);
	let { params = {} } = $$props;
	const slug = params.slug;

	const fetchData = async () => {
		const result = await get(`${URI_DEDUKTIF_DETAIL}/${slug}`);
		return await result;
	};
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<DeduktifDetail> was created with unknown prop '${key}'`);
	});
	...
	(fetchData().then(data => {
		return $$invalidate(2, title = data.title);
	}));
...
class DeduktifDetail extends SvelteComponentDev {
	constructor(options) {
		super(options);
	...
	get params() {
		throw new Error("<DeduktifDetail>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set params(value) {
		throw new Error("<DeduktifDetail>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
}

export { DeduktifDetail as default };
//# sourceMappingURL=DeduktifDetail-5d2fa0e0.js.map
