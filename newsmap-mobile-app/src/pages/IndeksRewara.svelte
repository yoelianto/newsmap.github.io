<script>
    ...
    const searchData = (async () => {
        let result1 = await get(ihttp.URI_REWARA_LIST, {size: 1000});
        let result2 = await get(ihttp.URI_REWARA_LIST, {size: 1000});
...
<article style="margin-top:{height}px">
    <h1>REWARA</h1>
    <form>
        <input type="search" placeholder="Cari Artikel Rewara..." bind:value={searchValue}>
