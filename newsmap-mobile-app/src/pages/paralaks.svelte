<script>
    ...
    const searchData = (async () => {
        let searchResult = await get(ihttp.URI_SEARCH, { keywords:searchValue , type:'infogram' }) 
...
<article style="margin-top:{height}px">
    <h1>PARALAKS</h1>
    <!-- <form> -->
        <input type="search" placeholder="Cari Artikel Paralaks..." on:keydown={submit} bind:value={searchValue}>
